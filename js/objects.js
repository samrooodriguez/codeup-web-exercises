(function () {
    ...
    console.log(person.lastName); // Rodriguez
    person.fullName(); // Sam Rodriguez
    person.sayHello(); // Hello from Sam Rodriguez
    // /**
    //  *
    ...
    //  */
        //Cameron has to pay $180;
        // Ryan has to pay $220;
        // George has to pay $281.60;
    var shoppers = [
            {
                name: 'Cameron',
                amount: 180
    ...
    var books = [
...

        {
            ...
            author: {firstName: "Jacqueline", lastName: "Susann"},
            date: 1966
        },

        {
            title: "Le Petit Prince",
            author: {firstName: "Antoine de", lastName: "Saint-Exupery"},
            date: 1943
        },
